# -*- coding: utf-8 -*-
"""
Created on Sat Jun 11 23:18:20 2016
...
TRAIN_SET = '/home/lael/Documents/trainResult0611_binary_downupSample.csv'
...
def XGBRegressorPred(params , dtrain ,dvalid, dtest, watch_list ,num_round):
    ...
    s=pickle.dumps(gbt)
    f= open('gbrt_up02.txt','w')
    
    f.write(s)
    f.close()
    '''
    gbt.save_model('gbdt02_up.model')
    gbt.dump_model('gbdt02_up.txt')
    '''
    submission = pd.DataFrame({'true gap': valid_y , 'pred_gap': valid_y_pred}, columns=['true_gap','pred_gap'])
    submission.to_csv("/home/lael/Documents/xgboost_biggap.csv",index=False)
